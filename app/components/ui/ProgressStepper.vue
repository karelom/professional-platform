  ...
  <div class="flex items-center w-full">
    <template v-for="(step, i) in steps" :key="step.key">
      <div
        ...
        :class="i === 0 || i === steps.length - 1 ? 'flex-shrink-0' : 'flex-shrink-0'"
      >
        <div
...
const activeIndex = computed(() => steps.findIndex((s) => s.key === props.currentStep))
